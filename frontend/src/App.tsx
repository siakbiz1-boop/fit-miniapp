...
const styles: Record<string, any> = {
  ...
  statsModeBtnActive: {
    background: "linear-gradient(135deg, #6f83f6, #7ccfe6)",
    color: "#fff",
    borderColor: "rgba(111, 131, 246, 0.6)",
    boxShadow: "0 10px 20px rgba(79, 124, 230, 0.3)",
  },
  statsDatePicker: {
    display: "flex",
    alignItems: "center",
  ...
  statsBarShellActive: {
    width: 22,
    borderRadius: 14,
    border: "2px solid rgba(90, 120, 170, 0.65)",
    position: "relative",
    overflow: "hidden",
    boxSizing: "border-box",
  ...
  statsBarFill: {
    ...
    minHeight: 6,
    borderRadius: 12,
    background: "linear-gradient(180deg, #6f83f6, #5eaee9)",
  },
  statsDaysRow: {
    display: "flex",
    justifyContent: "space-between",
  ...
  financeBtn: {
    padding: "10px 16px",
    borderRadius: 12,
    border: "1px solid rgba(111, 131, 246, 0.6)",
    background: "linear-gradient(135deg, #6f83f6, #7ccfe6)",
    color: "#fff",
    fontWeight: 700,
    fontSize: 14,
    cursor: "pointer",
    whiteSpace: "nowrap",
    boxShadow: "0 10px 20px rgba(79, 124, 230, 0.25)",
  },
  financeSheet: {
    width: "100%",
    maxWidth: 520,
  ...
  clientStatsBarTrack: {
    height: 10,
    borderRadius: 999,
    background: "rgba(111, 131, 246, 0.18)",
    overflow: "hidden",
  },
  clientStatsBarFill: {
    height: "100%",
    borderRadius: 999,
    background: "linear-gradient(90deg, #6f83f6, #5eaee9)",
  },
  clientStatsCount: {
    fontSize: 13,
    fontWeight: 700,
